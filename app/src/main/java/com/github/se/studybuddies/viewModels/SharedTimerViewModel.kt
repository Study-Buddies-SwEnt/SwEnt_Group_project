...
class SharedTimerViewModel : ViewModel() {
            ...
            object : ValueEventListener {
              ...
              override fun onCancelled(error: DatabaseError) {
                Log.e(
                    ...
                    "Failed to listen to timer updates",
                    error.toException())
              }
            })
  }
  ...
  fun resetTimer(groupId: String) {
    viewModelScope.launch { updateTimer(groupId, TimerInfo()) }
  }
  ...
  private fun updateTimer(groupId: String, timerInfo: TimerInfo) {
    db.child("timers").child(groupId).setValue(timerInfo).addOnFailureListener { exception ->
