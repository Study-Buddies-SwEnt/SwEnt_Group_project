...
class ToDoListScreenTest : TestCase(kaspressoBuilder = Kaspresso.Builder.withComposeSupport()) {
  ...
  private val testTask1 =
      ToDo(testID1, "Name1", LocalDate.now(), testDescriptions, ToDoStatus.CREATED)
  private val testTask2 =
      ToDo(testID2, "Name2", LocalDate.now(), testDescriptions, ToDoStatus.CREATED)
  ...
  fun todoListIsDisplayed() {
    onComposeScreen<ToDoListScreen>(composeTestRule) {
      ...
      composeTestRule
          .onNodeWithTag("testTodo1_box", useUnmergedTree = true)
          .assertExists()
          .assertHasClickAction()
      composeTestRule
          .onNodeWithTag("testTodo2_box", useUnmergedTree = true)
          .assertExists()
          .assertHasClickAction()
      ...
      composeTestRule
          ...
          .assertExists()
      composeTestRule
          .onNodeWithTag("testTodo1_status_box", useUnmergedTree = true)
          .assertExists()
          .assertHasClickAction()
      composeTestRule
          .onNodeWithTag("testTodo1_date", useUnmergedTree = true)
          .assertExists()
  ...
  fun searchBarTest() {
    onComposeScreen<ToDoListScreen>(composeTestRule) {
      ...
      searchBarIcon.performClick()
      composeTestRule.onNodeWithTag("no_result_text", useUnmergedTree = true).assertIsDisplayed()
      noTaskText.assertIsNotDisplayed()
  ...
  fun taskStatusTest() {
    onComposeScreen<ToDoListScreen>(composeTestRule) {
      ...
      composeTestRule
          .onNodeWithTag("testTodo1_status_text", useUnmergedTree = true)
